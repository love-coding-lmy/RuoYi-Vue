<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="categoryCode" label="分类编码" width="200"></el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="父分类ID" prop="parentId">
          <treeselect v-model="form.parentId" :options="categoryOptions" :normalizer="normalizer" placeholder="选择父分类ID" />
        </el-form-item>
        <el-form-item label="分类名称" prop="categoryName">
...
<script>
import { listCategory, getCategory, delCategory, addCategory, updateCategory, treeselect } from "@/api/shop/product/category";
  ...
  methods: {
    ...
    getTreeselect() {
      treeselect().then(response => {
        ...
        const category = { categoryId: 0, categoryName: '顶级节点', children: [] };
